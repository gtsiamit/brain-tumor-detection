...
def train():
    ...
    X_train, y_train = normalize_image_data(input_array=X_train), normalize_image_data(
        input_array=y_train
    )
    X_val, y_val = normalize_image_data(input_array=X_val), normalize_image_data(
        input_array=y_val
    )
    X_test, y_test = normalize_image_data(input_array=X_test), normalize_image_data(
        input_array=y_test
    )

...
def build_unet_model(input_shape):
    ...
    down_conv1 = Conv2D(filters=INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(input_layer)
    down_conv1 = BatchNormalization()(down_conv1)
    down_conv1 = Activation('relu')(down_conv1)
    down_conv1 = Conv2D(filters=INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_conv1)
    down_conv1 = BatchNormalization()(down_conv1)
    down_conv1 = Activation('relu')(down_conv1)
    ...
    down_conv2 = Conv2D(filters=2*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_pool1)
    down_conv2 = BatchNormalization()(down_conv2)
    down_conv2 = Activation('relu')(down_conv2)
    down_conv2 = Conv2D(filters=2*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_conv2)
    down_conv2 = BatchNormalization()(down_conv2)
    down_conv2 = Activation('relu')(down_conv2)
    ...
    down_conv3 = Conv2D(filters=4*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_pool2)
    down_conv3 = BatchNormalization()(down_conv3)
    down_conv3 = Activation('relu')(down_conv3)
    down_conv3 = Conv2D(filters=4*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_conv3)
    down_conv3 = BatchNormalization()(down_conv3)
    down_conv3 = Activation('relu')(down_conv3)
    ...
    down_conv4 = Conv2D(filters=8*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_pool3)
    down_conv4 = BatchNormalization()(down_conv4)
    down_conv4 = Activation('relu')(down_conv4)
    down_conv4 = Conv2D(filters=8*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_conv4)
    down_conv4 = BatchNormalization()(down_conv4)
    down_conv4 = Activation('relu')(down_conv4)
    ...
    # Center block
    center_conv1 = Conv2D(filters=16*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(down_pool4)
    center_conv1 = BatchNormalization()(center_conv1)
    center_conv1 = Activation('relu')(center_conv1)
    center_conv2 = Conv2D(filters=16*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(center_conv1)
    ...
    up_conv4 = Conv2D(filters=8*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv4)
    up_conv4 = BatchNormalization()(up_conv4)
    up_conv4 = Activation('relu')(up_conv4)
    up_conv4 = Conv2D(filters=8*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv4)
    up_conv4 = BatchNormalization()(up_conv4)
    ...
    up_conv3 = Conv2D(filters=4*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv3)
    up_conv3 = BatchNormalization()(up_conv3)
    up_conv3 = Activation('relu')(up_conv3)
    up_conv3 = Conv2D(filters=4*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv3)
    up_conv3 = BatchNormalization()(up_conv3)
    ...
    up_conv2 = Conv2D(filters=2*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv2)
    up_conv2 = BatchNormalization()(up_conv2)
    up_conv2 = Activation('relu')(up_conv2)
    up_conv2 = Conv2D(filters=2*INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv2)
    up_conv2 = BatchNormalization()(up_conv2)
    ...
    up_conv1 = Conv2D(filters=INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv1)
    up_conv1 = BatchNormalization()(up_conv1)
    up_conv1 = Activation('relu')(up_conv1)
    up_conv1 = Conv2D(filters=INIT_FEATURES, kernel_size=(3,3), strides=(1,1), padding='same', kernel_initializer='he_normal', activation=None)(up_conv1)
    up_conv1 = BatchNormalization()(up_conv1)

...
def build_unet_model(input_shape: tuple):
    ...
    down_conv1 = BatchNormalization()(down_conv1)
    down_conv1 = Activation("relu")(down_conv1)
    down_pool1 = MaxPooling2D(pool_size=(2, 2), strides=None, padding="valid")(
        down_conv1
    )
    ...
    down_conv2 = BatchNormalization()(down_conv2)
    down_conv2 = Activation("relu")(down_conv2)
    down_pool2 = MaxPooling2D(pool_size=(2, 2), strides=None, padding="valid")(
        down_conv2
    )
    ...
    down_conv3 = BatchNormalization()(down_conv3)
    down_conv3 = Activation("relu")(down_conv3)
    down_pool3 = MaxPooling2D(pool_size=(2, 2), strides=None, padding="valid")(
        down_conv3
    )
    ...
    down_conv4 = BatchNormalization()(down_conv4)
    down_conv4 = Activation("relu")(down_conv4)
    down_pool4 = MaxPooling2D(pool_size=(2, 2), strides=None, padding="valid")(
        down_conv4
    )
    ...
    # 4th expansive block
    up_conv4 = Conv2D(
        filters=8 * INIT_FEATURES, kernel_size=(2, 2), strides=(1, 1), padding="same"
    )(UpSampling2D(size=(2, 2))(center_conv2))
    ...
    # 3rd expansive block
    up_conv3 = Conv2D(
        filters=4 * INIT_FEATURES, kernel_size=(2, 2), strides=(1, 1), padding="same"
    )(UpSampling2D(size=(2, 2))(up_conv4))
    ...
    # 2nd expansive block
    up_conv2 = Conv2D(
        filters=2 * INIT_FEATURES, kernel_size=(2, 2), strides=(1, 1), padding="same"
    )(UpSampling2D(size=(2, 2))(up_conv3))
    ...
    # 1st expansive block
    up_conv1 = Conv2D(
        filters=INIT_FEATURES, kernel_size=(2, 2), strides=(1, 1), padding="same"
    )(UpSampling2D(size=(2, 2))(up_conv2))
